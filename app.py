...
# ==========================================
# ส่วนตกแต่งหน้าจอ (Custom CSS) ให้ดูทันสมัยและเข้ากับธีมโหราศาสตร์
# ==========================================
st.markdown("""
<style>
/* 1. ปรับพื้นหลังหลักให้เป็นสีไล่ระดับ (Gradient) โทนจักรวาลมืด */
.stApp {
    background: linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%);
    color: #ffffff;
}

/* 2. ปรับแต่งแถบเมนูด้านข้าง (Sidebar) ให้กลมกลืน */
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #0f0c29 0%, #24243e 100%);
    border-right: 1px solid rgba(255, 255, 255, 0.1);
}

/* 3. ปรับแต่งกรอบข้อความแจ้งเตือน (Alerts) ให้โปร่งแสง (Glassmorphism) */
div.stAlert {
...
/* 4. ปรับแต่งตารางให้ดูหรูหราและอ่านง่ายขึ้น */
table {
    border-radius: 8px;
    overflow: hidden;
}
th {
    background-color: rgba(223, 175, 44, 0.2) !important; /* ไฮไลท์หัวตารางสีทองโปร่งแสง */
...
/* 5. ปรับสีฟอนต์หัวข้อและตัวหนังสือให้เป็นโทนสว่าง/สีทอง */
h1, h2, h3, h4 {
    color: #eccc68 !important; /* สีทองอ่อนๆ ดูมีระดับ */
